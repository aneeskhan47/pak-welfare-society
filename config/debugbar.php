    ...
    */
    ...
    'options' => [
        ...
        'gate' => [
            ...
            'timeline' => env('DEBUGBAR_OPTIONS_GATE_TIMELINE', true),      // Add mails to the timeline
        ],
        'db' => [
            ...
            'backtrace_exclude_paths' => [],   // Paths to exclude from backtrace. (in addition to defaults)
            'backtrace_editor_links' => env('DEBUGBAR_OPTIONS_DB_BACKTRACE_EDITOR_LINKS', true), // Add editor links to backtrace entries (non-vendor files only)
            ...
            'slow_threshold' => env('DEBUGBAR_OPTIONS_DB_SLOW_THRESHOLD', true), // Max query execution time (ms). Exceeding queries will be highlighted
        ...
        'events' => [
            ...
            'listeners' => env('DEBUGBAR_OPTIONS_EVENTS_LISTENERS', true), // Add listeners to the events data
        ...
        'cache' => [
            ...
            'timeline' => env('DEBUGBAR_OPTIONS_CACHE_TIMELINE', true),  // Add cache events to the timeline
        ],
        'http_client' => [
            'masked' => [],
